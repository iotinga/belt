...
public class StdinB3MessageProviderTest {
    ...
    StdinB3MessageProvider<GenericB3Message> sut;

    @BeforeEach
    void setup() {
        sut = new StdinB3MessageProvider<GenericB3Message>(GenericB3Message.class, om) {
            @Override
