...
public class ResourcesB3MessageProviderTest {
    ...
    ResourcesB3MessageProvider<GenericB3Message> sut;

    @BeforeEach
    void setup() {
        sut = new ResourcesB3MessageProvider<GenericB3Message>(GenericB3Message.class, om) {
            @Override
