...
public class JsonSchemaResourcesProviderTest {
    ...
    JsonSchemaResourcesProvider sut;
    JsonSchemaResourcesProvider sutWithException;



    @BeforeEach
    void setup() {
        sut = new JsonSchemaResourcesProvider(config, om, factory) {
            @Override
            public InputStream getSchemaInputStream(String topic) throws IOException {
                return INPUT_STREAM;
            }
        };
        sutWithException = new JsonSchemaResourcesProvider(config, om, factory) {
            @Override
            public InputStream getSchemaInputStream(String topic) throws IOException {
