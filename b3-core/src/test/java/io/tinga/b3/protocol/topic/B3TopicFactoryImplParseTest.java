...
public class B3TopicFactoryImplParseTest {
    ...
    void customRoot() {
        ...
        B3TopicRoot agent = sut.agent("item1");
    ...
    void buildValidEntityName() {
        B3TopicRoot entity = sut.entity("item2");
