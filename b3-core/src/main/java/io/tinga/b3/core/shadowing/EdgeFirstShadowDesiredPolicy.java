...
public class EdgeFirstShadowDesiredPolicy implements Agent.ShadowDesiredPolicy<JsonNode, GenericMessage> {
    ...
    @Inject
    public EdgeFirstShadowDesiredPolicy(VersionSafeExecutor executor, EdgeDriver<JsonNode, GenericMessage> fieldDriver,
