...
public class DesiredEntityMessageFromFileProvider implements DesiredEntityMessageProvider {

    private final static Logger log = LoggerFactory.getLogger(DesiredEntityMessageFromFileProvider.class);
