...
public enum TestGadgetCommandOption implements GadgetCommandOption {
    ...
    THREADING("t", true, TestGadgetComposition.class, TestGadgetComposition.CONCURRENT.name(),
            String.format("Chooses the threading model for modules execution (%s, %s)",
                    TestGadgetComposition.CONCURRENT,
                    TestGadgetComposition.SEQUENTIAL)),
    ...
    private TestGadgetCommandOption(String shortName, boolean hasArg, Class<?> type, String defaultValue,
            String description) {
        this.opt = shortName;
        this.hasArg = hasArg;
        this.type = type;
