...
public enum GroupAgentCommandOption implements GadgetCommandOption {
    ...
    ACTION(GroupAgentCommand.ACTION, true,GroupAgentCommandAction.class, GroupAgentCommandAction.SERVICE.name(), String.format("Defines the action to be performed between [SERVICE]. Defaults to: SERVICE")),
